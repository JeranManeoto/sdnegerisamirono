window.onload = function() {
  ...
  // delete id="footer6-41" and last section
  document.getElementById('footer6-41').remove();
...
<section data-bs-version="5.1" class="footer6 cid-uNQ1sd08Ee" once="footers" id="footer6-41">
        <div class="container">
            ...
            <div class="footer-lower">
                ...
                <div class="col-sm-12 copyright pl-0 d-flex align-items-center justify-content-center" style="gap: 10px;">
                    <p class="mbr-text mbr-fonts-style mbr-white display-7" style="margin: 0;">
                        © Copyright 2025 Julio H. J. Maneoto - Informatika Universitas Respati Yogyakarta
                    </p>
                </div>
            </div>
        </div>
